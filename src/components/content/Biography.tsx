...
export default function Biography() {
	return (
		<div className="bg-slate-600 flex items-center flex-col lg:flex-row gap-4 pt-12">
			<div className="w-auto flex lg:self-end">
				<ProfilePhoto />
			</div>
			<div className="my-0 mx-auto text-center lg:text-left pb-12 px-8">
				<p
					className="text-3xl lg:text-4xl font-extralight text-cyan-500"
					data-aos="zoom-in"
				>
					Hi, I'm Bruno 👋
				</p>
				<p
					className="text-cyan-300 font-jost tracking-wide font-bold text-3xl lg:text-5xl mt-4"
					data-aos="zoom-in"
				>
					Fullstack Web Developer
				</p>
				<p
					className="text-cyan-50 font-jost tracking-wide text-lg mt-2"
					data-aos="zoom-in"
				>
					with a passion for building web apps and automatization
				</p>
				<p className="text-cyan-50 text-md mt-9 lg:max-w-xl" data-aos="zoom-in">
